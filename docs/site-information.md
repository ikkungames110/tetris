...
- テトクラは独立開発・非公式であり、Tetris Holding、The Tetris Company、TETR.IOとの提携・協賛・承認関係がないと明記。
...
- 規約はこのサービス向けに作成し、TETR.IOの規約本文を転載していない。一切の責任を免除する条項は設けず、適用法令による利用者の権利を留保。
...
- [TETR.IO ABOUT](https://tetr.io/about/)：利用規約・プライバシー・OSS表記への導線と非自社商標の扱いを参考にした。
- [TETR.IO利用規約](https://tetr.io/about/terms/)、[プライバシーポリシー](https://tetr.io/about/privacy/)：サービスの説明、権利侵害の連絡先、データ用途等の章立てを確認。
